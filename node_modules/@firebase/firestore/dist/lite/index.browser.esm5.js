...
function Lr(t, e) {
    if (!(e instanceof gr || e instanceof _r)) throw new B(V, "Function ".concat(t, "() requires AppliableConstraints created with a call to 'where(...)', 'or(...)', or 'and(...)'."));
}
 ...
 * document contents.
 */ function Br(t) {
    var e = mn((t = ct(t, kn)).firestore), n = new Ur(t.firestore);
 ...
 */ function zr(t) {
    ...
    var r = mn(t.firestore), i = new Ur(t.firestore);
    return function(t, r) {
        return e(this, void 0, void 0, (function() {
            var e, i;
            return n(this, (function(n) {
                switch (n.label) {
                  case 0:
                    return e = A(t), i = en(e.serializer, Ie(r)), [ 4 /*yield*/ , e.R("RunQuery", i.parent, {
                  ...
                  case 1:
                    return [ 2 /*return*/ , n.sent().filter((function(t) {
                        ...
                        return function(t, e, n) {
                            var r = Xe(t, e.name), i = Ye(e.updateTime), o = e.createTime ? Ye(e.createTime) : le.min(), a = new ve({
                                mapValue: {
                                    fields: e.fields
                                }
                            });
                            return ge.newFoundDocument(r, i, o, a);
...
function Qr(t, e, n) {
    var r = Mr((t = ct(t, kn)).converter, e, n), i = Kn(Qn(t.firestore), "setDoc", t._key, r, null !== t.converter, n);
    return pn(mn(t.firestore), [ i.toMutation(t._key, Re.none()) ]);
}

function Kr(t, e, n) {
    for (var r = [], i = 3; i < arguments.length; i++) r[i - 3] = arguments[i];
    var o, a = Qn((t = ct(t, kn)).firestore);
    // For Compat types, we have to "extract" the underlying types before
    // performing validation.
        return o = "string" == typeof (e = p(e)) || e instanceof qn ? Zn(a, "updateDoc", t._key, e, n, r) : $n(a, "updateDoc", t._key, e), 
    pn(mn(t.firestore), [ o.toMutation(t._key, Re.exists(!0)) ]);
}
 ...
 */ function Gr(t) {
    return pn(mn((t = ct(t, kn)).firestore), [ new Le(t._key, Re.none()) ]);
}
 ...
 */ function Wr(t, e) {
    var n = Vn(t = ct(t, An)), r = Mr(t.converter, e), i = Kn(Qn(t.firestore), "addDoc", n._key, r, null !== n.converter, {});
    return pn(mn(t.firestore), [ i.toMutation(n._key, Re.exists(!1)) ]).then((function() {
        return n;
    }));
}
 ...
 */ function Hr(t, r) {
    var i = ct(t.firestore, gn), o = mn(i), a = function(t, e) {
        ...
        return new wt(e, t._aggregateType, t._internalFieldPath);
    }));
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  case 0:
                    ...
                    }(o.serializer, Ie(r), i), u = a.request, s = a.Z, c = u.parent, o.connection.g || delete u.parent, 
 ...
 */ function Zr(t, e) {
    var n, r;
    return t instanceof En && e instanceof En && t._aggregateType === e._aggregateType && (null === (n = t._internalFieldPath) || void 0 === n ? void 0 : n.canonicalString()) === (null === (r = e._internalFieldPath) || void 0 === r ? void 0 : r.canonicalString());
}
 ...
 */ var ai = /** @class */ function() {
    ...
    return t.prototype.set = function(t, e, n) {
        ...
        var r = ui(t, this._firestore), i = Mr(r.converter, e, n), o = Kn(this._dataReader, "WriteBatch.set", r._key, i, null !== r.converter, n);
        return this._mutations.push(o.toMutation(r._key, Re.none())), this;
        ...
        // For Compat types, we have to "extract" the underlying types before
        // performing validation.
                return o = "string" == typeof (e = p(e)) || e instanceof qn ? Zn(this._dataReader, "WriteBatch.update", a._key, e, n, r) : $n(this._dataReader, "WriteBatch.update", a._key, e), 
        this._mutations.push(o.toMutation(a._key, Re.exists(!0))), this;
    }, 
    /**
    ...
    t.prototype.delete = function(t) {
        ...
        return this._mutations = this._mutations.concat(new Le(e._key, Re.none())), this;
    }, 
    /**
 ...
 */ var ci = /** @class */ function() {
    ...
    t.prototype.precondition = function(t) {
        ...
        return !this.writtenDocs.has(t.toString()) && e ? e.isEqual(le.min()) ? Re.exists(!1) : Re.updateTime(e) : Re.none();
    }, 
    /**
    ...
    function t(t, e, n, r, i) {
        ...
        this.deferred = i, this.wt = n.maxAttempts, this.yt = new fn(this.asyncQueue, "transaction_retry" /* TimerId.TransactionRetry */)
    ...
    return t.prototype.run = function() {
        ...
        this.yt.K((function() {
            return e(t, void 0, void 0, (function() {
                var t, e, r = this;
                return n(this, (function(n) {
                    return t = new ci(this.datastore), (e = this._t(t)) && e.then((function(e) {
 ...
 * limitations under the License.
 */
/** The Platform's 'document' implementation or null if not available. */ function hi() {
 ...
 */ var pi, di = /** @class */ function() {
    ...
    function t() {
        ...
        this.yt = new fn(this, "async_queue_retry" /* TimerId.AsyncQueueRetry */), 
        // Visibility handler that triggers an immediate retry of all retryable
        // operations. Meant to speed up recovery when we regain file system access
        // after page comes into foreground.
        this.Dt = function() {
            var e = hi();
            e && b("AsyncQueue", "Visibility state changed to " + e.visibilityState), t.yt.H();
        };
        var e = hi();
    ...
    t.prototype.enqueueAndForget = function(t) {
        ...
        return this.Ft((function() {
            return e.Tt && e.Vt ? Promise.resolve() : (t().then(n.resolve, n.reject), n.promise);
        })).then((function() {
            return n.promise;
        }));
    ...
    t.prototype.xt = function() {
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  case 0:
                    if (0 === this.It.length) return [ 3 /*break*/ , 5 ];
                    n.label = 1;

                  case 1:
                    return n.trys.push([ 1, 3, , 4 ]), [ 4 /*yield*/ , this.It[0]() ];

                  case 2:
                    return n.sent(), this.It.shift(), this.yt.reset(), [ 3 /*break*/ , 4 ];
 ...
 */
        ...
        var i = di.createAndSchedule(this, t, e, n, (function(t) {
            return r.St(t);
        }));
        return this.At.push(i), i;
     ...
     */
    t.prototype.Ot = function(t) {
        for (var e = 0, n = this.At; e < n.length; e++) {
    ...
    t.prototype.kt = function(t) {
        ...
        // Note that draining may generate more delayed ops, so we do that first.
            ...
            e.At.sort((function(t, e) {
                return t.targetTimeMs - e.targetTimeMs;
            }));
            for (var n = 0, r = e.At; n < r.length; n++) {
                var i = r[n];
    ...
    return t.prototype.get = function(t) {
        var e = this, n = ui(t, this._firestore), r = new Ur(this._firestore);
        ...
        var r = ui(t, this._firestore), i = Mr(r.converter, e, n), o = Kn(this._dataReader, "Transaction.set", r._key, i, null !== r.converter, n);
        ...
        // For Compat types, we have to "extract" the underlying types before
        // performing validation.
                return o = "string" == typeof (e = p(e)) || e instanceof qn ? Zn(this._dataReader, "Transaction.update", a._key, e, n, r) : $n(this._dataReader, "Transaction.update", a._key, e), 
 ...
 */
function vi(t, e, n) {
    var r = mn(t = ct(t, gn)), i = Object.assign(Object.assign({}, li), n);
    !function(t) {
        if (t.maxAttempts < 1) throw new B(V, "Max attempts must be at least 1");
    }(i);
    var o = new z;
    return new fi(new yi, r, i, (function(n) {
        return e(new mi(t, n));
    }), o).run(), o.promise
    /**
 * Firestore Lite
...
pi = "".concat(i, "_lite"), g = pi, o(new c("firestore/lite", (function(t, e) {
...
a("firestore-lite", "3.11.0", ""), a("firestore-lite", "3.11.0", "esm5");

export { En as AggregateField, Sn as AggregateQuerySnapshot, Nn as Bytes, An as CollectionReference, kn as DocumentReference, lr as DocumentSnapshot, qn as FieldPath, Cn as FieldValue, gn as Firestore, B as FirestoreError, xn as GeoPoint, In as Query, _r as QueryCompositeFilterConstraint, mr as QueryConstraint, fr as QueryDocumentSnapshot, Dr as QueryEndAtConstraint, gr as QueryFieldFilterConstraint, kr as QueryLimitConstraint, Er as QueryOrderByConstraint, hr as QuerySnapshot, Fr as QueryStartAtConstraint, Ot as Timestamp, mi as Transaction, ai as WriteBatch, Wr as addDoc, Zr as aggregateFieldEqual, ti as aggregateQuerySnapshotEqual, Tr as and, ii as arrayRemove, ri as arrayUnion, Xr as average, Fn as collection, Pn as collectionGroup, bn as connectFirestoreEmulator, $r as count, Gr as deleteDoc, ei as deleteField, Vn as doc, Rn as documentId, Nr as endAt, Or as endBefore, Hr as getAggregate, Yr as getCount, Br as getDoc, zr as getDocs, _n as getFirestore, oi as increment, wn as initializeFirestore, Ir as limit, Ar as limitToLast, br as or, Sr as orderBy, vr as query, On as queryEqual, Dn as refEqual, vi as runTransaction, ni as serverTimestamp, Qr as setDoc, _ as setLogLevel, pr as snapshotEqual, Vr as startAfter, Pr as startAt, Jr as sum, Tn as terminate, Kr as updateDoc, wr as where, si as writeBatch };
