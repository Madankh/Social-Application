...
/** Tests `left` and `right` for equality based on the backend semantics. */ function jt(t, e) {
    ...
    switch (n) {
      ...
      case 9 /* TypeOrder.ArrayValue */ :
        return Tt(t.arrayValue.values || [], e.arrayValue.values || [], jt);

      case 10 /* TypeOrder.ObjectValue */ :
        return function(t, e) {
            const n = t.mapValue.fields || {}, r = e.mapValue.fields || {};
            if (Rt(n) !== Rt(r)) return !1;
            for (const t in n) if (n.hasOwnProperty(t) && (void 0 === r[t] || !jt(n[t], r[t]))) return !1;
            return !0;
        }
...
function Bt(t, e) {
    ...
    switch (n) {
      ...
      case 8 /* TypeOrder.GeoPointValue */ :
        return function(t, e) {
            const n = At(xt(t.latitude), xt(e.latitude));
            if (0 !== n) return n;
            return At(xt(t.longitude), xt(e.longitude));
...
function Qt(t, e) {
    ...
    const n = Ft(t), r = Ft(e), s = At(n.seconds, r.seconds);
    return 0 !== s ? s : At(n.nanos, r.nanos);
}
...
function ne(t, e) {
    return t instanceof te ? function(t, e) {
        return e instanceof te && t.op === e.op && t.field.isEqual(e.field) && jt(t.value, e.value);
...
/** A Filter that implements the array-contains-any operator. */ class he extends te {
    ...
    matches(t) {
        const e = t.data.field(this.field);
        return !(!Wt(e) || !e.arrayValue.values) && e.arrayValue.values.some((t => Ut(this.value.arrayValue, t)));
    }
}
 ...
 * property.
 */ function Ie(t, e = null, n = [], r = [], s = null, i = null, o = null) {
 ...
 */ function Ve(t) {
    ...
    if (null === e.q) {
        ...
        t.isKeyField() || e.q.push(new le(t)), e.q.push(new le(st.keyField(), "asc" /* Direction.ASCENDING */)); else {
            let t = !1;
 ...
 */ function $e(t) {
    const e = T(t);
    if (!e.O) if ("F" /* LimitType.First */ === e.limitType) e.O = Ie(e.path, e.collectionGroup, Ve(e), e.filters, e.limit, e.startAt, e.endAt); else {
        ...
        // We need to swap the cursors to match the now-flipped query ordering.
                const n = e.endAt ? new Jt(e.endAt.position, e.endAt.inclusive) : null, r = e.startAt ? new Jt(e.startAt.position, e.startAt.inclusive) : null;
        // Now return as a LimitType.First query.
        e.O = Ie(e.path, e.collectionGroup, t, e.filters, e.limit, n, r);
    }
    return e.O;
}
...
/** A mutation that deletes the document at the given key. */ class Be extends Le {
    constructor(t, e) {
...
function Xe(t) {
    return A(!!t), de.fromTimestamp(function(t) {
        const e = Ft(t);
        return new qt(e.seconds, e.nanos);
    }(t));
}
...
function on(t, e) {
    return "found" in e ? function(t, e) {
        ...
        const n = en(t, e.found.name), r = Xe(e.found.updateTime), s = e.found.createTime ? Xe(e.found.createTime) : de.min(), i = new ve({
            mapValue: {
...
async function _n(t, e) {
    const n = T(t), r = rn(n.serializer) + "/documents", s = {
        writes: e.map((t => un(n.serializer, t)))
    };
...
async function vn(t, e) {
    const n = T(t), r = rn(n.serializer) + "/documents", s = {
        documents: e.map((t => tn(n.serializer, t)))
    }, i = await n.R("BatchGetDocuments", r, s, e.length), o = new Map;
    i.forEach((t => {
        const e = on(n.serializer, t);
...
async function bn(t, e) {
    const n = T(t), r = cn(n.serializer, $e(e));
    return (await n.R("RunQuery", r.parent, {
        structuredQuery: r.structuredQuery
    })).filter((t => !!t.document)).map((t => function(t, e, n) {
        const r = en(t, e.name), s = Xe(e.updateTime), i = e.createTime ? Xe(e.createTime) : de.min(), o = new ve({
            mapValue: {
                fields: e.fields
            }
...
function An(t) {
    ...
    if (!In.has(t)) {
        ...
        new Z(e, n, r, s.host, s.ssl, s.experimentalForceLongPolling, s.experimentalAutoDetectLongPolling, s.useFetchStreams))), o = pn(t._databaseId), u = function(t, e, n, r) {
 ...
 */ class Rn {
     ...
     */    _terminate() {
        return function(t) {
            const e = In.get(t);
            e && (_("ComponentProvider", "Removing Datastore"), In.delete(t), e.terminate());
...
function Cn(t, e, ...n) {
    ...
    // 'undefined' and 'null'.
    1 === arguments.length && (e = It.N()), ot("doc", "path", e), t instanceof Rn) {
        const r = nt.fromString(e, ...n);
 ...
 */ class jn {
     ...
     */    static fromBase64String(t) {
        try {
            return new jn(Nt.fromBase64String(t));
        } catch (t) {
     ...
     */    static fromUint8Array(t) {
        return new jn(Nt.fromUint8Array(t));
    }
    /**
...
/** The result of parsing document data (e.g. for a setData call). */ class Gn {
    ...
    toMutation(t, e) {
        return null !== this.fieldMask ? new Ue(t, this.data, this.fieldMask, e, this.fieldTransforms) : new je(t, this.data, e, this.fieldTransforms);
    }
}
...
/** A "context" object passed around while parsing user data. */ class Hn {
    ...
    /** Returns a new context with the specified settings overwritten. */    nt(t) {
        return new Hn(Object.assign(Object.assign({}, this.settings), t), this.databaseId, this.serializer, this.ignoreUndefinedProperties, this.fieldTransforms, this.fieldMask);
    }
    rt(t) {
        var e;
    ...
    ct(t) {
        return pr(t, this.settings.methodName, this.settings.at || !1, this.path, this.settings.ht);
    }
    ...
    it(t) {
        ...
        if (Yn(this.et) && Wn.test(t)) throw this.ct('Document fields cannot begin and end with "__"');
    }
}
 ...
 */ class Jn {
    constructor(t, e, n) {
        this.databaseId = t, this.ignoreUndefinedProperties = e, this.serializer = n || pn(t);
    }
...
function Xn(t) {
    ...
    return new Jn(t._databaseId, !!e.ignoreUndefinedProperties, n);
}

/** Parse document data from a set() call. */ function Zn(t, e, n, r, s, i = {}) {
...
class rr extends Qn {
    ...
    _toFieldTransform(t) {
        const e = er(this, t, 
        /*array=*/ !0), n = this.ft.map((t => ar(t, e))), r = new qe(n);
...
class sr extends Qn {
    ...
    _toFieldTransform(t) {
        const e = er(this, t, 
        /*array=*/ !0), n = this.ft.map((t => ar(t, e))), r = new Oe(n);
        return new Ce(t.path, r);
    }
    isEqual(t) {
        // TODO(mrschmidt): Implement isEquals
...
class ir extends Qn {
    ...
    _toFieldTransform(t) {
        const e = new ke(t.serializer, Fe(t.serializer, this.dt));
...
/** Parse update data from a list of field/value arguments. */ function ur(t, e, n, r, s, i) {
    const o = t.lt(1 /* UserDataSource.Update */ , e, n), u = [ dr(e, r, n) ], c = [ s ];
 ...
 */ function cr(t, e, n, r = !1) {
    return ar(n, t.lt(r ? 4 /* UserDataSource.ArrayArgument */ : 3 /* UserDataSource.Argument */ , e));
}
 ...
 */
    return function(t, e) {
        ...
        if (!Yn(e.et)) throw e.ct(`${t._methodName}() can only be used with update() and set()`);
 ...
 */ (t, e), null;
    ...
    return function(t, e) {
        ...
        if (t instanceof xn) {
            ...
            return {
                referenceValue: Ze(t.firestore._databaseId || e.databaseId, t._key.path)
            };
        }
...
function lr(t) {
    return !("object" != typeof t || null === t || t instanceof Array || t instanceof Date || t instanceof qt || t instanceof zn || t instanceof jn || t instanceof xn || t instanceof Qn);
}
 ...
 */ function dr(t, e, n) {
    ...
    // FieldPath.
    e = d(e)) instanceof Un) return e._internalPath;
 ...
 */ function br(t, e) {
    return t = d(t), e = d(e), t instanceof gr && e instanceof gr ? t._firestore === e._firestore && t._key.isEqual(e._key) && (null === t._document ? null === e._document : t._document.isEqual(e._document)) && t._converter === e._converter : t instanceof vr && e instanceof vr && (Ln(t.query, e.query) && Tt(t.docs, e.docs, br));
}

/**
 * Helper that calls `fromDotSeparatedString()` but wraps any error thrown.
 */ function Er(t, e) {
    return "string" == typeof e ? mr(t, e) : e instanceof Un ? e._internalPath : e._delegate._internalPath;
}
...
function Tr(t, e, ...n) {
    let r = [];
    e instanceof Ir && r.push(e), r = r.concat(n), function(t) {
 ...
 */ class Rr extends Ar {
    ...
    _apply(t) {
        ...
        return zr(t._query, e), new Sn(t.firestore, t.converter, Ne(t._query, e));
    }
    _parse(t) {
        const e = Xn(t.firestore), n = function(t, e, n, r, s, i, o) {
            let u;
            if (s.isKeyField()) {
            ...
            } else "in" /* Operator.IN */ !== i && "not-in" /* Operator.NOT_IN */ !== i && "array-contains-any" /* Operator.ARRAY_CONTAINS_ANY */ !== i || Qr(o, i), 
            u = cr(n, e, o, 
 ...
 */ class Vr extends Ir {
    ...
    _apply(t) {
        ...
        return 0 === e.getFilters().length ? t : (function(t, e) {
            ...
            for (const t of r) zr(n, t), n = Ne(n, t);
        }
...
function Lr(...t) {
    return Mr._create("endBefore", t, 
    /*inclusive=*/ !1);
}

function jr(...t) {
    return Mr._create("endAt", t, 
    /*inclusive=*/ !0);
}
...
/** Helper function to create a bound from a document or fields */ function Ur(t, e, n, r) {
    if (n[0] = d(n[0]), n[0] instanceof gr) return function(t, e, n, r, s) {
        ...
        // results.
                for (const n of Ve(t)) if (n.field.isKeyField()) i.push(zt(e, r.key)); else {
...
function Br(t, e, n) {
    ...
    if (n instanceof xn) return zt(t, n._key);
...
class Yr extends class {
    ...
    convertGeoPoint(t) {
        return new zn(xt(t.latitude), xt(t.longitude));
    }
    convertArray(t, e) {
 ...
 * document contents.
 */ function Hr(t) {
    const e = An((t = ht(t, xn)).firestore), n = new Yr(t.firestore);
 ...
 */ function Jr(t) {
    ...
    const e = An(t.firestore), n = new Yr(t.firestore);
...
function Xr(t, e, n) {
    const r = Kr((t = ht(t, xn)).converter, e, n), s = Zn(Xn(t.firestore), "setDoc", t._key, r, null !== t.converter, n);
    return _n(An(t.firestore), [ s.toMutation(t._key, Me.none()) ]);
}

function Zr(t, e, n, ...r) {
    const s = Xn((t = ht(t, xn)).firestore);
    // For Compat types, we have to "extract" the underlying types before
    // performing validation.
        let i;
    i = "string" == typeof (e = d(e)) || e instanceof Un ? ur(s, "updateDoc", t._key, e, n, r) : or(s, "updateDoc", t._key, e);
    return _n(An(t.firestore), [ i.toMutation(t._key, Me.exists(!0)) ]);
}
 ...
 */ function ts(t) {
    return _n(An((t = ht(t, xn)).firestore), [ new Be(t._key, Me.none()) ]);
}
 ...
 */ function es(t, e) {
    const n = Cn(t = ht(t, qn)), r = Kr(t.converter, e), s = Zn(Xn(t.firestore), "addDoc", n._key, r, null !== n.converter, {});
    return _n(An(t.firestore), [ s.toMutation(n._key, Me.exists(!1)) ]).then((() => n));
}
 ...
 */ function rs(t, e) {
    const n = ht(t.firestore, Rn), r = An(n), s = function(t, e) {
        const n = [];
        for (const r in t) Object.prototype.hasOwnProperty.call(t, r) && n.push(e(t[r], r, t));
        return n;
    }(e, ((t, e) => new bt(e, t._aggregateType, t._internalFieldPath)));
 ...
 * otherwise.
 */ function cs(t, e) {
    return Ln(t.query, e.query) && w(t.data(), e.data());
}
 ...
 */ class ws {
    ...
    constructor(t, e) {
        ...
        this._dataReader = Xn(t);
    }
    set(t, e, n) {
        this._verifyNotCommitted();
        const r = ms(t, this._firestore), s = Kr(r.converter, e, n), i = Zn(this._dataReader, "WriteBatch.set", r._key, s, null !== r.converter, n);
        return this._mutations.push(i.toMutation(r._key, Me.none())), this;
    }
    update(t, e, n, ...r) {
        this._verifyNotCommitted();
        ...
        // performing validation.
                let i;
        return i = "string" == typeof (e = d(e)) || e instanceof Un ? ur(this._dataReader, "WriteBatch.update", s._key, e, n, r) : or(this._dataReader, "WriteBatch.update", s._key, e), 
        this._mutations.push(i.toMutation(s._key, Me.exists(!0))), this;
    }
    /**
     ...
     */    delete(t) {
        ...
        return this._mutations = this._mutations.concat(new Be(e._key, Me.none())), this;
    }
    /**
 ...
 */ class ys {
     ...
     */    precondition(t) {
        ...
        return !this.writtenDocs.has(t.toString()) && e ? e.isEqual(de.min()) ? Me.exists(!1) : Me.updateTime(e) : Me.none();
    }
    /**
...
class _s {
    constructor(t, e, n, r, s) {
        ...
        this.deferred = s, this.wt = n.maxAttempts, this.yt = new yn(this.asyncQueue, "transaction_retry" /* TimerId.TransactionRetry */);
    }
    ...
    gt() {
        this.yt.K((async () => {
            const t = new ys(this.datastore), e = this._t(t);
            e && e.then((e => {
 ...
 */ class Es {
    constructor() {
        ...
        this.yt = new yn(this, "async_queue_retry" /* TimerId.AsyncQueueRetry */), 
        // Visibility handler that triggers an immediate retry of all retryable
        // operations. Meant to speed up recovery when we regain file system access
        // after page comes into foreground.
        this.Nt = () => {
            const t = vs();
            t && _("AsyncQueue", "Visibility state changed to " + t.visibilityState), this.yt.H();
        };
        const t = vs();
    ...
    enqueue(t) {
        ...
        // advance the queue even when the operation is not run.
                const e = new Q;
        return this.Ft((() => this.At && this.Vt ? Promise.resolve() : (t().then(e.resolve, e.reject), 
 ...
 */ (t);
    ...
    enqueueAfterDelay(t, e, n) {
        ...
        const r = bs.createAndSchedule(this, t, e, n, (t => this.St(t)));
...
class Is {
    /** @hideconstructor */
    constructor(t, e) {
        this._firestore = t, this._transaction = e, this._dataReader = Xn(t);
    }
    /**
    ...
    set(t, e, n) {
        const r = ms(t, this._firestore), s = Kr(r.converter, e, n), i = Zn(this._dataReader, "Transaction.set", r._key, s, null !== r.converter, n);
    ...
    update(t, e, n, ...r) {
        ...
        // performing validation.
                let i;
        return i = "string" == typeof (e = d(e)) || e instanceof Un ? ur(this._dataReader, "Transaction.update", s._key, e, n, r) : or(this._dataReader, "Transaction.update", s._key, e), 
 ...
 */ function As(t, e, n) {
    const r = An(t = ht(t, Rn)), s = Object.assign(Object.assign({}, gs), n);
    !function(t) {
        if (t.maxAttempts < 1) throw new B($, "Max attempts must be at least 1");
    }(s);
    const i = new Q;
    return new _s(new Es, r, s, (n => e(new Is(t, n))), i).run(), i.promise;
}
 ...
 */ !function(t) {
    ...
    const r = t.getProvider("app").getImmediate(), s = new Rn(new K(t.getProvider("auth-internal")), new X(t.getProvider("app-check-internal")), function(t, e) {
...
r("firestore-lite", "3.11.0", "rn"), r("firestore-lite", "3.11.0", "esm2017");

export { Dn as AggregateField, Fn as AggregateQuerySnapshot, jn as Bytes, qn as CollectionReference, xn as DocumentReference, gr as DocumentSnapshot, Un as FieldPath, Qn as FieldValue, Rn as Firestore, B as FirestoreError, zn as GeoPoint, Sn as Query, Vr as QueryCompositeFilterConstraint, Ar as QueryConstraint, _r as QueryDocumentSnapshot, Mr as QueryEndAtConstraint, Rr as QueryFieldFilterConstraint, xr as QueryLimitConstraint, Dr as QueryOrderByConstraint, vr as QuerySnapshot, Or as QueryStartAtConstraint, qt as Timestamp, Is as Transaction, ws as WriteBatch, es as addDoc, us as aggregateFieldEqual, cs as aggregateQuerySnapshotEqual, Nr as and, fs as arrayRemove, ls as arrayUnion, is as average, On as collection, kn as collectionGroup, $n as connectFirestoreEmulator, os as count, ts as deleteDoc, as as deleteField, Cn as doc, Bn as documentId, jr as endAt, Lr as endBefore, rs as getAggregate, ns as getCount, Hr as getDoc, Jr as getDocs, Vn as getFirestore, ds as increment, Pn as initializeFirestore, Sr as limit, qr as limitToLast, $r as or, Fr as orderBy, Tr as query, Ln as queryEqual, Mn as refEqual, As as runTransaction, hs as serverTimestamp, Xr as setDoc, g as setLogLevel, br as snapshotEqual, Cr as startAfter, kr as startAt, ss as sum, Nn as terminate, Zr as updateDoc, Pr as where, ps as writeBatch };
