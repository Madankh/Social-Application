 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ const T = "ok", A = "cancelled", R = "unknown", P = "invalid-argument", V = "deadline-exceeded", $ = "not-found", D = "already-exists", N = "permission-denied", F = "unauthenticated", x = "resource-exhausted", S = "failed-precondition", q = "aborted", O = "out-of-range", k = "unimplemented", C = "internal", M = "unavailable", L = "data-loss";
    ...
    static fromBase64String(t) {
        const e = function(t) {
            try {
                ...
                throw "undefined" != typeof DOMException && t instanceof DOMException ? new Rt("Invalid base64 string: " + t) : t;
            }
        }
...
/** Creates a deep copy of `source`. */ function Gt(t) {
    ...
    if (t.mapValue) {
        ...
        return At(t.mapValue.fields, ((t, n) => e.mapValue.fields[t] = Gt(n))), e;
    }
    if (t.arrayValue) {
        const e = {
            arrayValue: {
...
class Jt extends Ht {
     ...
     */    static create(t, e, n) {
        return t.isKeyField() ? "in" /* Operator.IN */ === e || "not-in" /* Operator.NOT_IN */ === e ? this.createKeyFieldInFilter(t, e, n) : new te(t, e, n) : "array-contains" /* Operator.ARRAY_CONTAINS */ === e ? new se(t, n) : "in" /* Operator.IN */ === e ? new ie(t, n) : "not-in" /* Operator.NOT_IN */ === e ? new oe(t, n) : "array-contains-any" /* Operator.ARRAY_CONTAINS_ANY */ === e ? new ue(t, n) : new Jt(t, e, n);
    }
    ...
    matches(t) {
        ...
        // Types do not have to match in NOT_EQUAL filters.
                return "!=" /* Operator.NOT_EQUAL */ === this.op ? null !== e && this.matchesComparison(Lt(e, this.value)) : null !== e && kt(this.value) === kt(e) && this.matchesComparison(Lt(e, this.value));
...
function Zt(t, e) {
    return t instanceof Jt ? function(t, e) {
        return e instanceof Jt && t.op === e.op && t.field.isEqual(e.field) && Ct(t.value, e.value);
    }(t, e) : t instanceof Xt ? function(t, e) {
        if (e instanceof Xt && t.op === e.op && t.filters.length === e.filters.length) {
            return t.filters.reduce(((t, n, r) => t && Zt(n, e.filters[r])), !0);
        }
        return !1;
    }
...
/** Filter that matches on key fields within an array. */ class ee extends Jt {
    constructor(t, e) {
...
/** Filter that matches on key fields not present within an array. */ class ne extends Jt {
    constructor(t, e) {
...
/** A Filter that implements the array-contains operator. */ class se extends Jt {
    constructor(t, e) {
        super(t, "array-contains" /* Operator.ARRAY_CONTAINS */ , e);
    }
    matches(t) {
        const e = t.data.field(this.field);
        return Bt(e) && Mt(e.arrayValue, this.value);
    }
}

/** A Filter that implements the IN operator. */ class ie extends Jt {
    constructor(t, e) {
...
/** A Filter that implements the not-in operator. */ class oe extends Jt {
    constructor(t, e) {
...
/** A Filter that implements the array-contains-any operator. */ class ue extends Jt {
    constructor(t, e) {
        super(t, "array-contains-any" /* Operator.ARRAY_CONTAINS_ANY */ , e);
    }
    matches(t) {
        const e = t.data.field(this.field);
        return !(!Bt(e) || !e.arrayValue.values) && e.arrayValue.values.some((t => Mt(this.value.arrayValue, t)));
    }
}
 ...
 */ function Ae(t) {
    ...
    if (null === e.q) {
        ...
        t.isKeyField() || e.q.push(new ce(t)), e.q.push(new ce(nt.keyField(), "asc" /* Direction.ASCENDING */)); else {
            let t = !1;
 ...
 */ function Re(t) {
    const e = I(t);
    if (!e.O) if ("F" /* LimitType.First */ === e.limitType) e.O = ve(e.path, e.collectionGroup, Ae(e), e.filters, e.limit, e.startAt, e.endAt); else {
        ...
        e.O = ve(e.path, e.collectionGroup, t, e.filters, e.limit, n, r);
    }
    return e.O;
}

function Pe(t, e) {
    e.getFirstInequalityField(), Ie(t);
...
function Ve(t, e) {
    return function(t, e) {
        ...
        for (let n = 0; n < t.filters.length; n++) if (!Zt(t.filters[n], e.filters[n])) return !1;
...
/** A mutation that deletes the document at the given key. */ class Le extends ke {
    constructor(t, e) {
...
function nn(t, e) {
    return "found" in e ? function(t, e) {
        ...
        const n = Xe(t, e.found.name), r = Ye(e.found.updateTime), s = e.found.createTime ? Ye(e.found.createTime) : he.min(), i = new ye({
            mapValue: {
        ...
        const n = Xe(t, e.missing), r = Ye(e.readTime);
...
function sn(t, e) {
    ...
    const s = function(t) {
        ...
        return hn(Xt.create(t, "and" /* CompositeOperator.AND */));
    }(e.filters);
...
function hn(t) {
    return t instanceof Jt ? function(t) {
 ...
 * limitations under the License.
 */ function dn(t) {
    return new ze(t, /* useProto3Json= */ !0);
}
...
async function pn(t, e) {
    const n = I(t), r = tn(n.serializer) + "/documents", s = {
        writes: e.map((t => rn(n.serializer, t)))
    };
...
async function yn(t, e) {
    const n = I(t), r = tn(n.serializer) + "/documents", s = {
        documents: e.map((t => Je(n.serializer, t)))
    }, i = await n.R("BatchGetDocuments", r, s, e.length), o = new Map;
    i.forEach((t => {
        const e = nn(n.serializer, t);
...
async function gn(t, e) {
    const n = I(t), r = sn(n.serializer, Re(e));
    return (await n.R("RunQuery", r.parent, {
        structuredQuery: r.structuredQuery
    })).filter((t => !!t.document)).map((t => function(t, e, n) {
        const r = Xe(t, e.name), s = Ye(e.updateTime), i = e.createTime ? Ye(e.createTime) : he.min(), o = new ye({
            mapValue: {
                fields: e.fields
            }
...
async function _n(t, e, n) {
    ...
    }(s.serializer, Re(e), n), u = i.parent;
...
function bn(t) {
    ...
    if (!vn.has(t)) {
        ...
        new J(e, n, r, s.host, s.ssl, s.experimentalForceLongPolling, s.experimentalAutoDetectLongPolling, s.useFetchStreams))), o = dn(t._databaseId), u = function(t, e, n, r) {
 ...
 */ function Rn(t, e, n, r = {}) {
    var s;
    const i = (t = ct(t, In))._getSettings();
 ...
 * terminated.
 */ function Pn(t) {
    return t = ct(t, In), _removeServiceInstance(t.app, "firestore/lite"), t._delete();
}
...
function xn(t, e, ...n) {
    if (t = getModularInstance(t), st("collection", "path", e), t instanceof In) {
 ...
 */ function Sn(t, e) {
    if (t = ct(t, In), st("collectionGroup", "collection id", e), e.indexOf("/") >= 0) throw new U(P, `Invalid collection ID '${e}' passed to function collectionGroup(). Collection IDs must not contain '/'.`);
    return new Nn(t, 
...
function qn(t, e, ...n) {
    ...
    // 'undefined' and 'null'.
    1 === arguments.length && (e = bt.D()), st("doc", "path", e), t instanceof In) {
        const r = tt.fromString(e, ...n);
...
/** The result of parsing document data (e.g. for a setData call). */ class Qn {
    constructor(t, e, n) {
        this.data = t, this.fieldMask = e, this.fieldTransforms = n;
    }
    toMutation(t, e) {
        return null !== this.fieldMask ? new Me(t, this.data, this.fieldMask, e, this.fieldTransforms) : new Ce(t, this.data, e, this.fieldTransforms);
    }
}

/** The result of parsing "update" data (i.e. for an updateData call). */ class zn {
    constructor(t, 
...
/** A "context" object passed around while parsing user data. */ class Gn {
    ...
    /** Returns a new context with the specified settings overwritten. */    nt(t) {
        return new Gn(Object.assign(Object.assign({}, this.settings), t), this.databaseId, this.serializer, this.ignoreUndefinedProperties, this.fieldTransforms, this.fieldMask);
    }
    rt(t) {
        var e;
    ...
    ct(t) {
        return dr(t, this.settings.methodName, this.settings.at || !1, this.path, this.settings.ht);
    }
    ...
    it(t) {
        ...
        if (Wn(this.et) && Bn.test(t)) throw this.ct('Document fields cannot begin and end with "__"');
    }
}
 ...
 */ class Kn {
    constructor(t, e, n) {
        this.databaseId = t, this.ignoreUndefinedProperties = e, this.serializer = n || dn(t);
    }
...
class tr extends Un {
    ...
    _toFieldTransform(t) {
        const e = Xn(this, t, 
        /*array=*/ !0), n = this.ft.map((t => or(t, e))), r = new Fe(n);
...
class er extends Un {
    ...
    _toFieldTransform(t) {
        const e = Xn(this, t, 
        /*array=*/ !0), n = this.ft.map((t => or(t, e))), r = new xe(n);
        return new qe(t.path, r);
    }
    isEqual(t) {
        // TODO(mrschmidt): Implement isEquals
...
class nr extends Un {
    ...
    _toFieldTransform(t) {
        const e = new Se(t.serializer, $e(t.serializer, this.dt));
...
/** Parse update data from an update() call. */ function rr(t, e, n, r) {
    ...
    const u = new pe(i);
    return new zn(o, u, s.fieldTransforms);
}

/** Parse update data from a list of field/value arguments. */ function sr(t, e, n, r, s, i) {
    const o = t.lt(1 /* UserDataSource.Update */ , e, n), u = [ hr(e, r, n) ], c = [ s ];
    ...
    const f = new pe(a);
    return new zn(h, f, o.fieldTransforms);
}
 ...
 */ function ir(t, e, n, r = !1) {
    return or(n, t.lt(r ? 4 /* UserDataSource.ArrayArgument */ : 3 /* UserDataSource.Argument */ , e));
}
 ...
 */
    return function(t, e) {
        ...
        if (!Wn(e.et)) throw e.ct(`${t._methodName}() can only be used with update() and set()`);
 ...
 */ (t, e), null;
    ...
    return function(t, e) {
        ...
        if ("number" == typeof t) return $e(e.serializer, t);
 ...
 */ function gr(t, e) {
    return t = getModularInstance(t), e = getModularInstance(e), t instanceof mr && e instanceof mr ? t._firestore === e._firestore && t._key.isEqual(e._key) && (null === t._document ? null === e._document : t._document.isEqual(e._document)) && t._converter === e._converter : t instanceof yr && e instanceof yr && (kn(t.query, e.query) && It(t.docs, e.docs, gr));
}

/**
 * Helper that calls `fromDotSeparatedString()` but wraps any error thrown.
 */ function _r(t, e) {
    return "string" == typeof e ? fr(t, e) : e instanceof Mn ? e._internalPath : e._delegate._internalPath;
}
...
function Er(t, e, ...n) {
    ...
    e instanceof vr && r.push(e), r = r.concat(n), function(t) {
        const e = t.filter((t => t instanceof Ar)).length, n = t.filter((t => t instanceof Ir)).length;
 ...
 */ class Ar extends vr {
    ...
    _parse(t) {
        ...
        return 1 === e.length ? e[0] : Xt.create(e, this._getOperator());
    }
    _apply(t) {
        const e = this._parse(t);
 ...
 */ function Rr(...t) {
    ...
    return t.forEach((t => Qr("or", t))), Ar._create("or" /* CompositeOperator.OR */ , t);
}
 ...
 */ function Pr(...t) {
    // Only support QueryFilterConstraints
    return t.forEach((t => Qr("and", t))), Ar._create("and" /* CompositeOperator.AND */ , t);
}
 ...
 */ class xr extends br {
    ...
    _apply(t) {
        const e = Mr(t, this.type, this._docOrFields, this._inclusive);
        return new Nn(t.firestore, t.converter, function(t, e) {
...
/** Helper function to create a bound from a document or fields */ function Mr(t, e, n, r) {
    if (n[0] = getModularInstance(n[0]), n[0] instanceof mr) return function(t, e, n, r, s) {
        ...
        // results.
                for (const n of Ae(t)) if (n.field.isKeyField()) i.push(jt(e, r.key)); else {
        ...
        return function(t, e, n, r, s, i) {
            ...
            for (let i = 0; i < s.length; i++) {
                ...
                if (o[i].field.isKeyField()) {
                    ...
                    if (!Te(t) && -1 !== c.indexOf("/")) throw new U(P, `Invalid query. When querying a collection and ordering by documentId(), the value passed to ${r}() must be a plain document ID, but '${c}' contains a slash.`);
...
function Lr(t, e, n) {
    if ("string" == typeof (n = getModularInstance(n))) {
        ...
        if (!Te(e) && -1 !== n.indexOf("/")) throw new U(P, `Invalid query. When querying a collection by documentId(), you must provide a plain document ID, but '${n}' contains a '/' character.`);
...
function Qr(t, e) {
    if (!(e instanceof Ir || e instanceof Ar)) throw new U(P, `Function ${t}() requires AppliableConstraints created with a call to 'where(...)', 'or(...)', or 'and(...)'.`);
}
...
function Yr(t, e, n) {
    const r = zr((t = ct(t, Dn)).converter, e, n), s = Hn(Yn(t.firestore), "setDoc", t._key, r, null !== t.converter, n);
...
function Hr(t, e, n, ...r) {
    ...
    // performing validation.
        let i;
    i = "string" == typeof (e = getModularInstance(e)) || e instanceof Mn ? sr(s, "updateDoc", t._key, e, n, r) : rr(s, "updateDoc", t._key, e);
 ...
 */ function Jr(t) {
    return pn(bn((t = ct(t, Dn)).firestore), [ new Le(t._key, Oe.none()) ]);
}
 ...
 */ function Xr(t, e) {
    const n = qn(t = ct(t, Fn)), r = zr(t.converter, e), s = Hn(Yn(t.firestore), "addDoc", n._key, r, null !== n.converter, {});
 ...
 */ function ts(t, e) {
    const n = ct(t.firestore, In), r = bn(n), s = function(t, e) {
        const n = [];
        for (const r in t) Object.prototype.hasOwnProperty.call(t, r) && n.push(e(t[r], r, t));
        return n;
    }(e, ((t, e) => new _t(e, t._aggregateType, t._internalFieldPath)));
 ...
 */ class ls {
    ...
    set(t, e, n) {
        ...
        const r = fs(t, this._firestore), s = zr(r.converter, e, n), i = Hn(this._dataReader, "WriteBatch.set", r._key, s, null !== r.converter, n);
    ...
    update(t, e, n, ...r) {
        ...
        // performing validation.
                let i;
        return i = "string" == typeof (e = getModularInstance(e)) || e instanceof Mn ? sr(this._dataReader, "WriteBatch.update", s._key, e, n, r) : rr(this._dataReader, "WriteBatch.update", s._key, e), 
     ...
     */    delete(t) {
        ...
        return this._mutations = this._mutations.concat(new Le(e._key, Oe.none())), this;
    }
    /**
...
class ps {
    constructor(t, e, n, r, s) {
        ...
        this.deferred = s, this.wt = n.maxAttempts, this.yt = new wn(this.asyncQueue, "transaction_retry" /* TimerId.TransactionRetry */);
    }
    ...
    gt() {
        this.yt.K((async () => {
            const t = new ws(this.datastore), e = this._t(t);
            e && e.then((e => {
 ...
 */ class _s {
    constructor() {
        ...
        this.yt = new wn(this, "async_queue_retry" /* TimerId.AsyncQueueRetry */), 
        // Visibility handler that triggers an immediate retry of all retryable
        // operations. Meant to speed up recovery when we regain file system access
        // after page comes into foreground.
        this.Dt = () => {
            const t = ys();
            t && y("AsyncQueue", "Visibility state changed to " + t.visibilityState), this.yt.H();
        };
        const t = ys();
    ...
    enqueue(t) {
        ...
        // advance the queue even when the operation is not run.
                const e = new j;
        return this.Ft((() => this.Tt && this.Vt ? Promise.resolve() : (t().then(e.resolve, e.reject), 
        e.promise))).then((() => e.promise));
    }
    enqueueRetryable(t) {
        this.enqueueAndForget((() => (this.It.push(t), this.xt())));
    }
    /**
     ...
     */    async xt() {
        if (0 !== this.It.length) {
            try {
                await this.It[0](), this.It.shift(), this.yt.reset();
            } catch (t) {
                if (!
                /**
 * @license
 ...
 */ (t);
    ...
    enqueueAfterDelay(t, e, n) {
        ...
        const r = gs.createAndSchedule(this, t, e, n, (t => this.St(t)));
     ...
     * exists.
     */    Ot(t) {
        for (const e of this.At) if (e.timerId === t) return !0;
        return !1;
    }
    /**
     ...
     */    kt(t) {
        ...
        return this.qt().then((() => {
            ...
            this.At.sort(((t, e) => t.targetTimeMs - e.targetTimeMs));
            for (const e of this.At) if (e.skipDelay(), "all" /* TimerId.All */ !== t && e.timerId === t) break;
            return this.qt();
        }));
    }
    /**
...
class vs {
    ...
    set(t, e, n) {
        const r = fs(t, this._firestore), s = zr(r.converter, e, n), i = Hn(this._dataReader, "Transaction.set", r._key, s, null !== r.converter, n);
    ...
    update(t, e, n, ...r) {
        ...
        // performing validation.
                let i;
        return i = "string" == typeof (e = getModularInstance(e)) || e instanceof Mn ? sr(this._dataReader, "Transaction.update", s._key, e, n, r) : rr(this._dataReader, "Transaction.update", s._key, e), 
 ...
 */ function bs(t, e, n) {
    const r = bn(t = ct(t, In)), s = Object.assign(Object.assign({}, ms), n);
    !function(t) {
 ...
 */ !function(t) {
    ...
    const r = t.getProvider("app").getImmediate(), s = new In(new W(t.getProvider("auth-internal")), new H(t.getProvider("app-check-internal")), function(t, e) {
...
registerVersion("firestore-lite", "3.11.0", ""), registerVersion("firestore-lite", "3.11.0", "esm2017");
